 ...
 * @author Eric
 */
public class TransfMercadoria extends javax.swing.JFrame {
    ...
    //public formRequisicao(int codigo, String nome, int quantidade) {
     public TransfMercadoria() {
        initComponents();
     }
    
    
     public TransfMercadoria(Requisicao requisicao) {
        initComponents();
...
// create a class User and use it to populate the arraylist
    ...
    private void initComponents() {
        ...
        botEnviaRequis.setText("Confirmar transferência da mercadoria");
    ...
    private void botVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botVoltarActionPerformed
        JOptionPane.showMessageDialog(null, "A mercadoria nao foi transferida");
        requisicao.setStatus("Transferencia Cancelada");
    ...
    private void botEnviaRequisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botEnviaRequisActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Mercadoria transferida com sucesso");
        requisicao.setStatus("Transferência Aceita");
        // Vou mandar um tipo requisicao para a tela TipoPedido
 
        
        // Construtor da proxima tela 
        EmbarqueMercadoria tela = new EmbarqueMercadoria(requisicao);
        tela.setVisible(true);
        this.setVisible(false);
