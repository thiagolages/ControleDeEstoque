 ...
 * @author Eric
 */
public class EmbarqueMercadoria extends javax.swing.JFrame {
    ...
    //public formRequisicao(int codigo, String nome, int quantidade) {
     public EmbarqueMercadoria() {
        initComponents();
     }
    
    
     public EmbarqueMercadoria(Requisicao requisicao) {
        initComponents();
...
// create a class User and use it to populate the arraylist
    ...
    private void initComponents() {
        ...
        botEnviaRequis.setText("Confirmar embarque de  mercadoria");
    ...
    private void botVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botVoltarActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "A mercadoria nao foi embarcada");
        requisicao.setStatus("Embarque nao informado");
    ...
    private void botEnviaRequisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botEnviaRequisActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Mercadoria embarcada com sucesso");
        requisicao.setStatus("Mercadoria em Transito");
        // Vou mandar um tipo requisicao para a tela TipoPedido
 
        EntregaMercadoria tela = new EntregaMercadoria(requisicao);
        tela.setVisible(true);
        this.setVisible(false);
