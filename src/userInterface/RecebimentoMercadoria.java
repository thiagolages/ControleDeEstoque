 ...
 * @author Eric
 */
public class RecebimentoMercadoria extends javax.swing.JFrame {
    ...
    //public formRequisicao(int codigo, String nome, int quantidade) {
     public RecebimentoMercadoria() {
        initComponents();
     }
    
    
     public RecebimentoMercadoria(Requisicao requisicao) {
        initComponents();
...
// create a class User and use it to populate the arraylist
    ...
    private void initComponents() {
        ...
        botEnviaRequis.setText("Confirmar recebimento de mercadoria");
    ...
    private void botVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botVoltarActionPerformed
        JOptionPane.showMessageDialog(null, "A mercadoria nao foi recebida");
        requisicao.setStatus("Entrega nao realizada");
    ...
    private void botEnviaRequisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botEnviaRequisActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Mercadoria recebida com sucesso");
        requisicao.setStatus("Mercadoria em estoque");
